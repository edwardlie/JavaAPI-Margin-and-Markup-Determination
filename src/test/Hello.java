...
public class Hello {
	...
	public String calcProfitHTML(@QueryParam("name") String name, @QueryParam("revenue") double revenue, @QueryParam("COGS") double cogs){
		...
		return "<html>" + "<title>" + "Profit information for " + name + "</title>"
